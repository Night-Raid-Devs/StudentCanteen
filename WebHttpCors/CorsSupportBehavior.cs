...
namespace WebHttpCors
{
    ...
    public class CorsMessageInspector : IDispatchMessageInspector
    {
        ...
        public void BeforeSendReply(ref Message reply, object correlationState)
        {
            ...
            var requestProperty = OperationContext.Current.IncomingMessageProperties[HttpRequestMessageProperty.Name] as HttpRequestMessageProperty;
            var origin = requestProperty.Headers["origin"];
            property.Headers.Add("Access-Control-Allow-Origin", origin == null ? "null" : origin);
